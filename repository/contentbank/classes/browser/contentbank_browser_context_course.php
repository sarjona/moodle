...
class contentbank_browser_context_course extends contentbank_browser {
    ...
    public function can_access_content(): bool {
        // The content bank repository should enable managers, course creators teachers to share the content created
        // in course context level all over the site. Therefore, by default, the content from the course context level
        // should be available to managers, course creators and editing teachers enrolled in the course.
