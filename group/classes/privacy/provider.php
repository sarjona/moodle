...
class provider implements
    ...
    public static function export_groups(\context $context, string $component, array $subcontext = [], int $itemid = 0) {
        ...
        if (!empty($groups)) {
            ...
            foreach ($groups as $group) {
                ...
                \core_message\privacy\provider::export_conversations($USER->id, $context, 'core_group', 'groups', $group->groupid);
            }
        }
    }
    ...
    public static function get_group_members_in_context(userlist $userlist, string $component, int $itemid = 0) {
        ...
        \core_message\privacy\provider::get_conversations_in_context($userlist, 'core_group', 'groups', $itemid);
    }
    ...
    public static function get_contexts_for_group_member(int $userid, string $component, int $itemid = 0) {
        ...
        \core_message\privacy\provider::get_contexts_for_conversations($contextlist, $userid, 'core_group', 'groups', $itemid);
