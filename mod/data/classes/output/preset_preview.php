...
class preset_preview implements templatable, renderable {
    ...
    public function export_for_template(\renderer_base $output): array {
        ...
        $parser = new template($this->manager, $templatecontent, ['templatename' => $this->templatename], $fields);
        $content = $parser->parse_entries($entries);
        if ($this->templatename == 'listtemplate') {
            $content = $instance->listtemplateheader . $content . $instance->listtemplatefooter;
        }
