...
class action_bar {
    ...
    public function get_fields_action_bar(bool $hasfieldselect = false, bool $hassaveaspreset = false,
        ...
        $fieldsactionbar = new fields_action_bar($this->id, null, $fieldselect);
    ...
    public function get_presets_action_bar(): string {
        ...
        $renderer = $PAGE->get_renderer('mod_data');
        $presetsactionbar = new presets_action_bar($this->id, $this->get_presets_actions_select(true));
    ...
    protected function get_presets_actions_select(bool $hasimport = false): ?\action_menu {
        ...
        if ($hasimport) {
            // Import.
            $actionsselectparams = ['d' => $this->id, 'action' => 'import'];
