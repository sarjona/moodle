...
class import_presets extends dynamic_form {
    ...
    protected function check_access_for_dynamic_submission(): void {
        if (!has_capability('mod/data:manageuserpresets', $this->get_context_for_dynamic_submission())) {
            throw new moodle_exception('importpresetpresetmissingcapability', 'data');
        }
    }
    ...
    protected function definition() {
        $mform = $this->_form;
        $mform->addElement('header', 'uploadpreset', get_string('fromfile', 'data'));
        $mform->addHelpButton('uploadpreset', 'fromfile', 'data');
