...
Feature: Users can use the Image gallery preset
  ...
  Background:
    ...
    And the following "mod_data > entries" exist:
      | database | user      | title           | caption                                  | image             |
      | data1    | student1  | First image     | This is the caption text for image 1     | first.png         |
      | data1    | teacher1  | Second image    | And this is the caption text for image 2 | second.png        |
  ...
  Scenario: Users view entries
    ...
    And I should see "This is the caption text for image 1"
    ...
    And I should see "And this is the caption text for image 2"
    ...
    And I should not see "And this is the caption text for image 2"
    And I should not see "Pau Teacher"
    ...
    And I should not see "This is the caption text for image 1"
  ...
  Scenario: Users can add entries
    ...
    And I set the field "caption" to "This is the caption for the new image."
    And I press "Save"
    Then I should see "New image"
    And I should see "This is the caption for the new image."
