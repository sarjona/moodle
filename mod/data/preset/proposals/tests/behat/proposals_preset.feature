...
Feature: Users can use the Proposals preset
  ...
  Background:
    ...
    And the following "mod_data > entries" exist:
      | database | user      | Title                           | Content                                  | Content status    |
      | data1    | student1  | Project created by student      | This is the content for the entry 1      | Pending           |
      | data1    | teacher1  | Project created by teacher      | And this is the content for the entry 2  | Rejected          |
  ...
  Scenario: Proposals. Users view entries
    ...
    And "This is the content for the entry 1" "text" should exist
    ...
    And "And this is the content for the entry 2" "text" should exist
  ...
  Scenario: Proposals. Users can add entries
    ...
    And I set the field "Content status" to "Approved"
    And I press "Save"
    Then I should see "This is the title"
    And I should see "Approved"
    And "This is the content for the new entry." "text" should exist
