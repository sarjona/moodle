...
/**
 * Disable the data module for new installs
 *
 * @package mod_data
...
/**
 * Code run after the mod_data module database tables have been created.
...
function xmldb_data_install() {
    ...
    // Hide the module.
    return $DB->set_field('modules', 'visible', '0', ['name' => 'data']);
