 ...
 * @param  string $path
 * @return string
 * @deprecated since Moodle 4.1 MDL-75148 - please, use the manager::get_plugin_preset_name() function instead.
 * @todo MDL-75189 This will be deleted in Moodle 4.5.
 * @see manager::get_plugin_preset_name()
 */
function data_preset_name($shortname, $path) {
    debugging('data_preset_name() is deprecated. Please use manager::get_plugin_preset_name() instead.', DEBUG_DEVELOPER);

    return manager::get_plugin_preset_name($shortname);
}
...
function data_get_available_presets($context) {
    ...
    return manager::get_available_presets($context);
}
...
function data_get_available_site_presets($context, array $presets=array()) {
    ...
    $savedpresets = manager::get_available_saved_presets($context);
 ...
 *
 * @deprecated since Moodle 4.1 MDL-75148 - please, use the manager::is_directory_a_preset() function instead.
 * @todo MDL-75189 This will be deleted in Moodle 4.5.
 * @see manager::is_directory_a_preset()
 */
function is_directory_a_preset($directory) {
    debugging('is_directory_a_preset() is deprecated. Please use manager::is_directory_a_preset() instead.', DEBUG_DEVELOPER);

    return manager::is_directory_a_preset($directory);
}
...
abstract class data_preset_importer {
    ...
    public function get_preset_settings() {
        ...
        $fs = $fileobj = null;
        if (!manager::is_directory_a_preset($this->directory)) {
...
function data_presets_export($course, $cm, $data, $tostorage=false) {
    ...
    if (! manager::is_directory_a_preset($exportdir)) {
