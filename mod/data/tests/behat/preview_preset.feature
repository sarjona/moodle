...
Feature: Users can preview presets
  ...
  Scenario: Preview a plugin preset in database
    Given I follow "Presets"
    When I click on "Image gallery" "link"
    Then I should see "Use this preset to collect images." in the "template-preview" "region"
    And "More" "icon" should exist in the "template-preview" "region"
    And "Edit" "icon" should exist in the "template-preview" "region"
    And "Delete" "icon" should exist in the "template-preview" "region"
    ...
    And "More" "icon" should not exist in the "template-preview" "region"
    And "Edit" "icon" should exist in the "template-preview" "region"
    And "Delete" "icon" should exist in the "template-preview" "region"
    And I should see "This is a short text" in the "template-preview" "region"
