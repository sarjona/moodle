...
final class locallib_test extends \advanced_testcase {
    ...
    public function test_count_submissions_count_assessments(): void {
        ...
        $this->assertEquals(2, $manager->count_submissions());
        $this->assertEquals(2, $manager->count_submissions('all'));
        $this->assertEquals(1, $manager->count_submissions($student1->id));
        $this->assertEquals(1, $manager->count_submissions($student2->id));

        $this->assertEquals(1, $manager->count_submissions('all', $group1->id));
        ...
        $this->assertEquals(2, $manager->count_assessments());
        $this->assertEquals(1, $manager->count_assessments(true));

        $this->assertEquals(1, $manager->count_assessments(false, $group1->id));
