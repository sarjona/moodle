...
class mod_h5pactivity_generator_testcase extends advanced_testcase {
    ...
    public function test_create_instance() {
        ...
        // Create one activity.
        $this->assertFalse($DB->record_exists('h5pactivity', array('course' => $course->id)));
        $activity = $this->getDataGenerator()->create_module('h5pactivity', array('course' => $course));
        $records = $DB->get_records('h5pactivity', array('course' => $course->id), 'id');
        ...
        $params = array('course' => $course->id, 'name' => 'Another h5pactivity', 'displayoptions' => 6);
