...
$string['enablesavestate_help'] = 'Automatically save the current state of the content for each user. Users may resume where they left off.';
...
$string['savestatefreq_help'] = 'How often the state of the content will be auto-saved for each user (in seconds).';
$string['score'] = 'Score';
