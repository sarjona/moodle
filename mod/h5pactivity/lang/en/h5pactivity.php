...
$string['h5pactivity_help'] = 'Use this module to use a H5P compatible content as a course activity.';
...
$string['h5pactivityname_help'] = 'Use this module to use a H5P compatible content as a course activity.';
