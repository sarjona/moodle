...
class core_message_api_testcase extends core_message_messagelib_testcase {
   ...
   public function get_conversations_mixed_provider() {
    ...
    public function test_get_conversation_messages() {
        ...
        // Send some messages back and forth.
        $time = 1;
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Yo!', $time + 1);
        \core_message\test\fake_message::send_fake_message_to_conversation($user2, $conversation->id, 'Sup mang?', $time + 2);
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Writing PHPUnit tests!',
            $time + 3);
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Word.', $time + 4);
    ...
    public function test_get_group_conversation_messages() {
        ...
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Yo!', $time + 1);
        \core_message\test\fake_message::send_fake_message_to_conversation($user2, $conversation->id, 'Sup mang?', $time + 2);
        \core_message\test\fake_message::send_fake_message_to_conversation($user3, $conversation->id, 'Writing PHPUnit tests!',
            $time + 3);
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Word.', $time + 4);
        \core_message\test\fake_message::send_fake_message_to_conversation($user2, $conversation->id, 'Yeah!', $time + 5);
    ...
    public function test_get_conversation_messages_time_from_only() {
        ...
        // Send some messages back and forth.
        $time = 1;
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Message 1', $time + 1);
        \core_message\test\fake_message::send_fake_message_to_conversation($user2, $conversation->id, 'Message 2', $time + 2);
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Message 3', $time + 3);
        \core_message\test\fake_message::send_fake_message_to_conversation($user3, $conversation->id, 'Message 4', $time + 4);
    ...
    public function test_get_most_recent_conversation_message() {
        ...
        \core_message\test\fake_message::send_fake_message_to_conversation($user1, $conversation->id, 'Writing PHPUnit tests!',
            $time + 3);
        \core_message\test\fake_message::send_fake_message_to_conversation($user2, $conversation->id, 'Word.', $time + 4);
