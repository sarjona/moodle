...
function(
     ...
     * @param {Object} body The body container element.
     * @param {Object} footer The footer container element.
     * @param {String} showmessage The message to display in the dialogue or null if it should be hidden
     * @return {Object} jQuery promise
     */
    var renderConfirmDeleteConversation = function(header, body, footer, showmessage) {
        if (showmessage) {
