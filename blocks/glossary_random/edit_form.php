...
class block_glossary_random_edit_form extends block_edit_form {
    protected function specific_definition($mform) {
        ...
        $showrefreshbuttonadmindefault = get_config('block_glossary_random', 'config_showrefreshbutton');
        $mform->setDefault('config_showrefreshbutton', $showrefreshbuttonadmindefault);
