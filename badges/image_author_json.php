...
$json['type'] = OB2_TYPE_AUTHOR;
if (!empty($badge->nameauthorimage)) {
    $json['name'] = $badge->nameauthorimage;
}
if (!empty($badge->emailauthorimage)) {
    $json['email'] = $badge->emailauthorimage;
}
if (!empty($badge->urlauthorimage)) {
    $json['url'] = $badge->urlauthorimage;
}
echo $OUTPUT->header();
