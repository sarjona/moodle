...
class core_badges_renderer extends plugin_renderer_base {
    ...
    public function print_badge_overview($badge, $context) {
        ...
        $dl[get_string('nameauthorimage', 'badges')] =
            html_writer::link($badge->nameauthorimage, $badge->nameauthorimage, array('target' => '_blank'));
        $dl[get_string('emailauthorimage', 'badges')] =
            html_writer::tag('a', $badge->emailauthorimage, array('href' => 'mailto:' . $badge->emailauthorimage));
        $dl[get_string('urlauthorimage', 'badges')] =
            html_writer::link($badge->urlauthorimage, $badge->urlauthorimage, array('target' => '_blank'));
