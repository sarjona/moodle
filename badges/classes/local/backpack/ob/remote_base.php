...
abstract class remote_base {
    ...
    /**
     * Return the API version supported by this backpack (OPEN_BADGES_V2, OPEN_BADGES_V2P1...).
     *
     ...
     *
     * @return bool True if the backpack was successfully disconnected, false otherwise.
     */
    ...
    /**
     * Connect to the backpack and return the proper URL for authorization/verification.
     *
     * @param  $data The data to send to the backpack for connection.
     * @return url|null The authorization/verification URL or null if no required required after backpack connection.
     * @throws \moodle_exception
     */
    abstract public function connect_backpack($data): ?url;

    /**
     * Validate the given backpack form data.
     *
     * @param $data The form data to validate.
     * @return array An array with the errors found in the form data or an empty array if no errors.
     */
    abstract public function validate_backpack_form($data): array;
