...
/**
 * Represent a request backpack method, its parameters and the response.
 *
 * @package    core_badges
 * @copyright  2025 Sara Arjona <sara@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class request_session extends request_base {
    ...
    /**
     * Parse the response from OB login.
     *
     * @param \stdClass $response The request response data.
