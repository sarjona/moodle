...
Feature: Backpack badges
  ...
  Scenario: Verify backback settings
    ...
    And I click on "Up" "link" in the "https://dc.imsglobal.org" "table_row"
  ...
  Scenario: Move up and down site backpack
    ...
    And I log in as "admin"
    And I navigate to "Badges > Manage backpacks" in site administration
    And "Up" "icon" should exist in the "https://dc.imsglobal.org" "table_row"
    And "Down" "icon" should exist in the "https://dc.imsglobal.org" "table_row"
    When I click on "Up" "link" in the "https://dc.imsglobal.org" "table_row"
    Then "Up" "icon" should not exist in the "https://dc.imsglobal.org" "table_row"
    And "Down" "icon" should exist in the "https://dc.imsglobal.org" "table_row"
    And I click on "Down" "link" in the "https://dc.imsglobal.org" "table_row"
    And I click on "Down" "link" in the "https://dc.imsglobal.org" "table_row"
    And "Up" "icon" should exist in the "https://dc.imsglobal.org" "table_row"
    And "Down" "icon" should not exist in the "https://dc.imsglobal.org" "table_row"
