...
if ($badge->status != BADGE_STATUS_INACTIVE) {
    if (is_null($action)) {
        ...
        if ($badge->authorimage || $badge->captionimage) {
            ...
            if ($badge->nameauthorimage || $badge->emailauthorimage || $badge->urlauthorimage) {
            ...
            if ($badge->captionimage) {
                $json['image']['caption'] = $badge->captionimage;
            }
        } else {
            $json['image'] = $urlimage;
        }
        ...
        $json['issuer'] = $badge->get_json_issuer_related_badge();
