...
Feature: Allow teachers to edit the default activity completion rules in a course.
  ...
  Scenario: Bulk edit activity completion default rules for assignment
  ...
  Scenario: Bulk edit activity completion default rules for forum
    Given the following "activity" exists:
      | activity | forum                |
      | course   | C1                   |
      | name     | Test forum one       |
  ...
  Scenario: Bulk edit activity completion default rules for glossary
    Given the following "activity" exists:
      | activity   | glossary             |
      | course     | C1                   |
