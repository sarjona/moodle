...
trait form_trait {
    ...
    protected function add_completion_elements(
        ...
        $customcompletionelements = $this->add_completion_rules($suffix);
    ...
    protected function validate_completion(array $data): array {
        ...
        $completionel = 'completion' . $suffix;
        $completionunlockedel = 'completionunlocked';
        ...
        $automaticcompletion = $automaticcompletion && !empty($data[$completionunlockedel]);
        if ($automaticcompletion) {
            ...
            $rulesenabled = $rulesenabled || $this->completion_rule_enabled($data, $suffix);
