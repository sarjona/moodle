...
abstract class core_completion_edit_base_form extends moodleform {
    ...
    public function definition() {
        ...
        if ($this->support_grades()) {
            // TODO: Does it make sense the disableif instead of hideIf for the bulk???
            $modname = null;
            $modnames = $this->get_module_names();
        ...
        if (!empty($group)) {
            $mform->addElement('static', 'completionautomatic_text', '', 'Activity is completed when students do all of the following');
