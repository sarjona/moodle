...
class core_completion_defaultedit_form extends core_completion_edit_base_form {
    ...
    /**
     * This method needs to be overridden because the form identifier needs to be unique for each module type.
     * Otherwise, the form will display the same data for each module type.
     */
