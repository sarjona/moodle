...
$string['irevokethepolicy'] = 'I revoke the policy';
...
$string['revokeacknowledgement'] = 'I acknowledge that consents to these policies have been revoked';
$string['revokedetails'] = 'Revoke details';
$string['save'] = 'Save';
...
$string['agreedyesonbehalfwithlink'] = 'Agreed on behalf of, click to revoke "{$a}"';
$string['agreedyesonbehalfwithlinkall'] = 'Agreed on behalf of, click to revoke all policies"';
$string['agreedyeswithlink'] = 'Agreed, click to revoke "{$a}"';
$string['agreedyeswithlinkall'] = 'Agreed, click to revoke all policies';
