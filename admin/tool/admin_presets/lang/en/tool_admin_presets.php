...
$string['exportshow'] = 'create a new preset';
...
$string['importshow'] = 'import preset file';
...
$string['plugindescription'] = 'Presets allow you to easily switch between different site admin configurations. After selecting a preset, you can turn on more features any time as required.';
...
$string['rollbackexecute'] = 'restore preset version';
...
$string['rollbackshow'] = 'versions history';
