    ...
    public function export_for_template(renderer_base $output): stdClass {
        ...
        foreach ($this->presets as $preset) {
            ...
            if ($this->showactions) {
                ...
                // Delete button won't be displayed for the pre-installed "Lite" and "Full" presets.
                $islite = $preset->name == get_string('litepreset', 'tool_admin_presets');
                $isfull = $preset->name == get_string('fullpreset', 'tool_admin_presets');
                if (!$islite && !$isfull) {
