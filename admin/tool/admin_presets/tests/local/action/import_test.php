...
class import_test extends \advanced_testcase {
    ...
    public function import_execute_provider(): array {
        return [
            ...
            'Import settings and plugins from a valid XML file with Lite name, which will be renamed' => [
                'filecontents' => file_get_contents(__DIR__ . '/../../fixtures/import_lite_name.xml'),
                'expectedpreset' => true,
                'expectedsettings' => true,
                'expectedplugins' => true,
                'expecteddebugging' => false,
                'expectedexception' => null,
                'expectedpresetname' => 'Renamed from Lite',
            ],
