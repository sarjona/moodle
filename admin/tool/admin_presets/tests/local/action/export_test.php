...
class export_test extends \advanced_testcase {
    ...
    public function test_export_execute(bool $includesensible = false, string $presetname = 'Export 1'): void {
        ...
        try {
            ...
            $this->assertEquals(helper::get_valid_preset_name($presetname), $preset->name);
    ...
    public function export_execute_provider(): array {
        return [
            ...
            'Export settings and plugins, with Lite name (it will be renamed)' => [
                'includesensible' => false,
                'presetname' => 'Lite',
            ],
            'Export settings and plugins, with Full name (it will be renamed)' => [
                'includesensible' => false,
                'presetname' => 'Full',
            ],
        ];
