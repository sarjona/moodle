...
Feature: Basic OAuth2 functionality
  ...
  Scenario: Create, edit and delete standard service for Google
    ...
    And I set the following fields to these values:
      | Name                       | Google testing service                    |
      | Client ID                  | thisistheclientid                         |
      | Client secret              | supersecret                               |
    When I press "Save changes"
    Then I should see "Changes saved"
    And I should see "Google testing service"
    And "Configured" "icon" should exist in the "Google testing service" "table_row"
    And "Allow login" "icon" should exist in the "Google testing service" "table_row"
    And "Service discovery successful" "icon" should exist in the "Google testing service" "table_row"
    And I click on "Configure endpoints" "link" in the "Google testing service" "table_row"
    ...
    And I click on "Configure user field mappings" "link" in the "Google testing service" "table_row"
    And I should see "firstname" in the "given_name" "table_row"
    And I should see "middlename" in the "middle_name" "table_row"
    And I follow "OAuth 2 services"
    And I click on "Edit" "link" in the "Google testing service" "table_row"
    And I set the following fields to these values:
      | Name                       | Google testing service modified            |
    And I press "Save changes"
    And I should see "Changes saved"
    And I should see "Google testing service modified"
    And I click on "Delete" "link" in the "Google testing service modified" "table_row"
    And I should see "Are you sure you want to delete the identity issuer \"Google testing service modified\"?"
    And I press "Continue"
    And I should see "Identity issuer deleted"
    And I should not see "Google testing service modified"
