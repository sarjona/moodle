...
$string['runner'] = 'Create testing scenarios';
$string['runner_description'] = 'Creating testing scenarios uses a limited feature files syntax to create all necessary elements to run a manual test.';
$string['runner_filedesc'] = 'The upload feature files can only contain scenarios with core_data_generator steps. It is not yet compatible with scenario outlines. All scenarios will be executed at once, event background steps.';
$string['runner_errorparsing'] = 'Error parsing feature file: {$a}';
$string['runner_file'] = 'Feature file';
$string['runner_invalidfile'] = 'The file format is not valid or contains invalid steps.';
$string['runner_invalidstep'] = 'Unkown step. Create testing scenarios only accepts generator steps.';
$string['runner_nosteps'] = 'There are no steps to execute in the file.';
$string['runner_notready'] = 'Composer and behat libraries are not installed. Please, execute this command to enable this tool: php admin/tool/behat/cli/init.php';
$string['runner_steps'] = 'Testing scenario steps:';
