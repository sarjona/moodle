...
/**
 * Tests for the course_get_state class.
 *
 * @package    core_course
 * @category   test
 * @copyright  2021 Sara Arjona (sara@moodle.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \core_course\external\course_get_state
 */
class course_get_state_test extends \externallib_advanced_testcase {
    ...
    /**
     * Test the behaviour of course_get_state::execute().
     *
    ...
    public function test_get_state(string $role, string $format = 'topics', ?string $expectedexception = null): void {
        ...
        // Get course state.
        $result = json_decode(course_get_state::execute($course->id));
