...
if ($deletesection) {
    ...
    $cancelurl = course_get_url($course, $sectioninfo, $params);
    if (course_can_delete_section($course, $sectioninfo)) {
        ...
        if ($confirm) {
            ...
            $courseurl = course_get_url($course, $sectioninfo->section - 1, $params);
            redirect($courseurl);
        } else {
...
if ($mform->is_cancelled()){
    ...
    redirect(course_get_url($course, $section, $params));
