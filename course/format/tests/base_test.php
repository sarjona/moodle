...
class base_test extends advanced_testcase {
    ...
    public function test_get_sections_preferences() {
        ...
        $data = (object)[
            'section_1' => (object)['something' => true],
            'section_2' => (object)['something' => false],
        ];
        ...
        $this->assertEquals($data->section_1->something, $preferences[1]->something);
        $this->assertEquals($data->section_2->something, $preferences[2]->something);
