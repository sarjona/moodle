 ...
 * Base class for library handlers.
 *
 * If a plugin wants to add a library handler it has to define class
...
abstract class handler {
     ...
     * @return null|string
     */
    abstract public static function get_h5p_core_library_base(?string $filepath = null): ?string;
    ...
    public static function get_h5p_core_library_url(?string $filepath = null): ?\moodle_url {
        // TODO: Add cache parameter to this method.
        return new \moodle_url(static::get_h5p_core_library_base($filepath));
    }
