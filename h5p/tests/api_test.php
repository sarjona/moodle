...
class api_testcase extends \advanced_testcase {
    ...
    /**
     * Test the behaviour of enable_library().
     *
     * @covers ::enable_library
     * @covers ::disable_library
     * @dataProvider enable_or_disable_library_provider
     *
     ...
     */
    public function test_enable_or_disable_library(string $libraryname, string $action, int $expected): void {
        global $DB;
        ...
        if ($library) {
            switch ($action) {
                case 'enable':
                    api::enable_library((int) $library->id);
                    break;
                case 'disable':
                    api::disable_library((int) $library->id);
                    break;
            }
        }
    ...
    /**
     * Data provider for test_enable_or_disable_library().
     *
     * @return array
     */
    public function enable_or_disable_library_provider(): array {
        return [
     ...
     * @param bool $useid Whether to use libraryname or id for calling is_library_enabled method.
     */
    public function test_is_library_enabled(string $libraryname, bool $expected, bool $useid = false): void {
        global $DB;
