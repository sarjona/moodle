...
class file_storage_test extends \advanced_testcase {
    ...
    public function test_get_custom_styles(): void {
        ...
        try {
            $style = file_storage::get_custom_styles();
            $this->fail('moodle_exception for \'noh5pcustomcss\' was not thrown');
        } catch (\moodle_exception $me) {
            $this->assertEquals('noh5pcustomcss', $me->errorcode);
        }
        ...
        try {
            $style = file_storage::get_custom_styles();
            $this->fail('moodle_exception for \'noh5pcustomcssfile\' was not thrown');
        } catch (\moodle_exception $me) {
            $this->assertEquals('noh5pcustomcssfile', $me->errorcode);
        }
    }
}
