...
Feature: Restore Moodle 2 course backups
  ...
  Scenario: Restore course badges without user data or activities
    Given the following "core_badges > Badges" exist:
      | name                                      | course | description                                           | image                        | status | type |
      | Published course badge                    | C1     | Published course badge description                    | badges/tests/behat/badge.png | active | 2    |
      | Unpublished course badge                  | C1     | Unpublished course badge description                  | badges/tests/behat/badge.png | 0      | 2    |
      | Unpublished without criteria course badge | C1     | Unpublished without criteria course badge description | badges/tests/behat/badge.png | 0      | 2    |
    ...
    And I backup "Course 1" course using this options:
      ...
      | Initial      | Include activities and resources | 0               |
      | Initial      | Include enrolled users           | 0               |
    ...
    # Badges exist but no criteria have been set up because the backup didn't include activities.
    And I should see "Criteria for this badge have not been set up yet" in the "Published course badge" "table_row"
    And I should see "Criteria for this badge have not been set up yet" in the "Unpublished course badge" "table_row"
  ...
  @javascript @core_badges
  Scenario: Restore course badges without user data but with activities
    Given the following "core_badges > Badges" exist:
      | name                                      | course | description       | image                        | status | type |
