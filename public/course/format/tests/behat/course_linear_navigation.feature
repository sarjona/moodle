...
Feature: Display the course linear navigation in the activity pages
  ...
  Scenario Template: As a user I should see the course linear navigation when format allows it.
  ...
  Scenario: The database module should not have a course navigation bar when the sticky footer is displayed.
