...
class recording extends persistent {
     ...
     * @param bool $ignoregroups if true will ignore groups and groupings from the current instance and
     * return all recordings linked to the instance.
     *
