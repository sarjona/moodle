...
class overview extends \core_courseformat\activityoverviewbase {
    ...
    private function get_extra_totalattempts_overview(): ?overviewitem {
        ...
        $totaluserattemptedcount = $this->manager->count_participants();
        ...
        $content = '-';
        if ($totaluserattemptedcount > 0 && $totalattempts) {
            $averageattempts = (int) round($totalattempts / $totaluserattemptedcount);
