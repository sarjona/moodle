...
class message extends base {
    ...
    public static function enable_plugin(string $pluginname, int $enabled): bool {
        ...
        if (!$plugin = $DB->get_record('message_processors', ['name' => $pluginname], '*', MUST_EXIST)) {
            new \moodle_exception('generalexceptionmessage', 'error', '', 'Unexpected message processor name: ' . $pluginname);
        }
