 ...
 *
 * Important: not all themes are compatible with stiky footer. If the current theme
 * is not compatible is will be rendered as a standard div element.
 *
 * @package    core
 * @category   output
...
class sticky_footer implements named_templatable, renderable {
    ...
    /**
     * @var string extra CSS classes. By default, elements are jusitified to the end.
     */
