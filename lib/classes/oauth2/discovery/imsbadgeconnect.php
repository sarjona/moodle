...
class imsbadgeconnect extends base_definition {
    ...
    /**
     * Self-register the issuer if the 'register' endpoint exists and client id and secret aren't defined.
     *
     * @param issuer $issuer The OAuth issuer to register.
     * @return void
     */
    public function register(issuer $issuer): void {
        global $CFG, $SITE;
        ...
        if (empty($clientid) && empty($clientsecret) && (!defined('PHPUNIT_TEST') || !PHPUNIT_TEST)) {
            ...
            if ($url) {
                ...
                $request = [
                    ...
                    'redirect_uris' => [
                        $hosturl . 'badges/oauth2callback.php'
                    ],
