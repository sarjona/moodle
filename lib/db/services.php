...
$functions = array(
   ...
   'core_backup_get_async_backup_links_restore' => array(
    ...
    'core_xapi_state_post' => [
        'classname'     => 'core_xapi\external\state_post',
        'classpath'     => '',
    ...
    'core_xapi_state_get' => [
        'classname'     => 'core_xapi\external\state_get',
        'classpath'     => '',
        'description'   => 'Get an xAPI state data form an activityId.',
        'type'          => 'read',
        'ajax'          => true,
        'capabilities'  => '',
        'services'      => [MOODLE_OFFICIAL_MOBILE_SERVICE],
    ],
    'core_xapi_state_delete' => [
        'classname'     => 'core_xapi\external\state_delete',
        'classpath'     => '',
        'description'   => 'Delete an xAPI state data form an activityId.',
        'type'          => 'write',
        'ajax'          => true,
        'capabilities'  => '',
        'services'      => [MOODLE_OFFICIAL_MOBILE_SERVICE],
