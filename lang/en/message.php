...
$string['conversationdoesntexist'] = 'You can not send a message to a conversation id ({$a}) that doesn\'t exist';
...
$string['usercantbemessaged'] = 'You can\'t send a message into this conversation, probably due to the user privacy message preferences. You need to be added as a contact.';
