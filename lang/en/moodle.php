...
$string['coursewithanydependencies'] = 'This course is currently unavailable to students. Any of the following courses need to be completed before: {$a}';
$string['coursewithalldependencies'] = 'This course is currently unavailable to students. All the following courses need to be completed before: {$a}';
...
$string['enddatewithtaskenabled_help'] = 'The course end date determines whether a course is listed as past in the course overview. The course end date may also be used by custom reports. When it matches the current date, the course visibility will be automatically set to "Hide" so users will stop having access to the course.';
...
$string['startdatewithtaskenabled_help'] = 'This setting determines the start of the first week for a course in weekly format. It also determines the earliest date that logs of course activities are available for. If the course is reset and the course start date changed, all dates in the course will be moved in relation to the new start date. When it matches the current date, the course visibility will be automatically set to "Show".';
