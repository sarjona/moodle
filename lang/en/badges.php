...
$string['error:duplicatename'] = 'A site badge with this name already exists. Choose a different name.';
$string['error:duplicatenameincourse'] = 'A badge with this name already exists in the course. Choose a different name.';
$string['error:duplicatenameincoursewhenenabling'] = 'Access to badge \'{$a}\' can\'t be enabled because a badge with the same name already exists in the course. Use a different name to enable access to this badge.';
$string['error:duplicatenamewhenenabling'] = 'Access to badge \'{$a}\' can\'t be enabled because a site badge with the same name already exists. Use a different name to enable access to this badge.';
