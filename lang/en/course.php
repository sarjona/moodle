...
$string['hideendedcoursestask'] = 'Hide automatically courses when current day matches end date';
...
$string['showstartedcoursestask'] = 'Show automatically courses when current day matches start date';
