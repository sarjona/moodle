...
/**
 * Disable the adaptivenopenaly question behaviour for new installs
 *
 ...
 * @return bool
 */
function xmldb_qbehaviour_adaptivenopenalty_install() {

    $class = core_plugin_manager::resolve_plugininfo_class('qbehaviour');
    $class::enable_plugin('adaptivenopenalty', false);
